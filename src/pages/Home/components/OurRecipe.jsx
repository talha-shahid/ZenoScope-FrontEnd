...
import { ourRecipe } from "../../../constants";
import StartSteps from "./secondary/StartSteps";
  ...
  return (
    <section className={`${styles.paddings} relative z-10`}>
      ...
      >
        ...
        >
          <TypingText title="| Our Recipe" textStyles="text-center" />
          <TitleText
            title="What’s so good about us?"
